...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AjoutClient_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AjoutClient_t qt_meta_stringdata_AjoutClient = {
    {
        QT_MOC_LITERAL(0, 11),  // "AjoutClient"
        QT_MOC_LITERAL(12, 24),  // "on_pushButton_10_clicked"
        QT_MOC_LITERAL(37, 0),  // ""
        QT_MOC_LITERAL(38, 23),  // "on_pushButton_9_clicked"
        QT_MOC_LITERAL(62, 23),  // "on_pushButton_8_clicked"
        QT_MOC_LITERAL(86, 23)   // "on_pushButton_7_clicked"
    },
    "AjoutClient",
...
Q_CONSTINIT static const uint qt_meta_data_AjoutClient[] = {
...
Q_CONSTINIT const QMetaObject AjoutClient::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_AjoutClient.offsetsAndSizes,
    qt_meta_data_AjoutClient,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AjoutClient_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AjoutClient, std::true_type>,
